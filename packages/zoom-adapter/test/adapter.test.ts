    ...
    describe('full', () => {
      it('should generate the right elements on fetch', async () => {
        ...
        expect(elements.map(e => e.elemID.getFullName()).sort()).toEqual([
          'zoom.business_hours_schedule',
          'zoom.business_hours_schedule.instance.Some_schedule@s',
          'zoom.business_hours_schedule__intervals',
          'zoom.business_hours_schedule_holiday',
          'zoom.business_hours_schedule_holiday.instance.Some_schedule__New_holiday1@suus',
          'zoom.group',
          'zoom.group.instance.group_1@s',
          'zoom.group.instance.group_2@s',
          'zoom.made_up_type_a',
          'zoom.made_up_type_a.instance.made_up_1@s',
          'zoom.made_up_type_a.instance.made_up_2@s',
          'zoom.made_up_type_a.instance.made_up_3@s',
          'zoom.made_up_type_b',
          'zoom.made_up_type_b.instance.made_up_1@s',
        ])
        expect(
          elements
        ...
        const madeUp2Values = elements
          .filter(isInstanceElement)
          .find(e => e.elemID.getFullName() === 'zoom.made_up_type_a.instance.made_up_2@s')?.value
        ...
        const madeUp3Values = elements
          .filter(isInstanceElement)
          .find(e => e.elemID.getFullName() === 'zoom.made_up_type_a.instance.made_up_3@s')?.value
